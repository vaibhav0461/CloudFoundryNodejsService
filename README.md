...
2. To start the application setup, Open command prompt, Go to the myapp directory and execute **npm init** (Install [node.js/npm](https://nodejs.org/en/download/)) in the command line. This will walk you through creating a **package.json** file.
